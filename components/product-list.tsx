      ...
      <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-2">
        <div className="flex justify-between items-center p-2.5 bg-white rounded-lg border-2 border-blue-400 shadow-md">
          <div>
            ...
            <div className="text-lg font-bold text-blue-700">${totalToShow.toFixed(2)}</div>
          </div>
        ...
        <div className="flex justify-between items-center p-2.5 bg-yellow-50 rounded-lg border-2 border-yellow-400 shadow-md">
          <div>
            ...
            {exchangeRates.bcv_euro ? (
              <div className="text-lg font-bold text-yellow-700">€ {convertToEuros(totalToShow, exchangeRates.bcv, exchangeRates.bcv_euro)}</div>
            ) : (
        ...
        <div className="flex justify-between items-center p-2.5 bg-green-50 rounded-lg border-2 border-green-400 shadow-md">
          <div>
            ...
            <div className="text-lg font-bold text-green-700">${(totalToShow - ahorroUsdParaleloBCV).toFixed(2)}</div>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-500">Bs.</div>
        ...
        <div className="flex justify-between items-center p-2.5 bg-purple-50 rounded-lg border-2 border-purple-400 shadow-md">
          <div>
            <div className="text-xs font-semibold text-purple-700 uppercase">Binance</div>
            <div className="text-lg font-bold text-purple-700">${(totalToShow - ahorroUsdBinanceBCV).toFixed(2)}</div>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-500">Bs.</div>
            <div className="text-lg font-bold text-purple-600">{binanceRateNum > 0 ? binanceValue.toFixed(2) : "..."}</div>
          </div>
        </div>
      </div>
