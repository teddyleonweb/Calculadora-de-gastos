...
export default function Home() {
  ...
  const handleImageCapture = (src: string | null) => {
    ...
    if (!src) {
      ...
      setErrorMessage("No se pudo cargar la imagen. Por favor, intente nuevamente.")
      return
    }
    ...
    const img = new Image()
    img.onload = () => {
      console.log("Imagen cargada correctamente en Home:", img.width, "x", img.height)
      setImageSrc(src)
    ...
    img.onerror = () => {
      console.error("Error al cargar la imagen en Home")
      setErrorMessage("Error al cargar la imagen. Por favor, intente con otra imagen.")
    }
    img.src = src
  }
